...
function get_game_by_age($age){
  ...
  global $connexion;
  $query ="SELECT jeu.id, jeu.titre, jeu.prix,restriction_age.label, jeu.image_path AS image FROM jeu INNER JOIN restriction_age ON jeu.age_id = restriction_age.id
